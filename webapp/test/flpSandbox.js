		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Stock Request",
									"targetURL": "#comreckittzpestockrequest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comreckittzpestockrequest-display": {
								"semanticObject": "comreckittzpestockrequest",
								"action": "display",
								"description": "PE UI5 application for Stock Request",
								"title": "Stock Request",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.reckitt.zpestockrequest",
									"url": sap.ui.require.toUrl("com/reckitt/zpestockrequest")
								}
							}
						}
					}
